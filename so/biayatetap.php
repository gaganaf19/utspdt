    ...
    <body class="sb-nav-fixed">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="bg">
                            ...
                            <div class="bg">
                            <a class="nav-link" href="biayatidaktetap.php">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <div class="bg">
                    <h1 class="mt-4 text-white" align="center" style="font-weight: bold; background-color: blue ; border: 3px solid black; border-radius: 5px;">Data Pengeluaran Tetap</h1>
                    </div>
                                ...
                                <table class="table table-bordered border-dark">
                                    ...
                                    ?>
                                        ...
                                        <tr align="center" style="font-weight: bold;">
                                            ...
                                            <button type="button" class="btn btn-warning text-white" data-bs-toggle="modal" data-bs-target="#edit<?=$idbiayatetap;?>">
                                                    Edit
                                            </button>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?=$idbiayatetap;?>">
                                                    Hapus
                                            </button>
                                         ...
                                         <!-- The Modal hapus-->
                                        <div class="modal" id="delete<?=$idbiayatetap;?>">
                                        <div class="modal-dialog">
                                            ...
                                            <input type="hidden" name="idbiayatetap" value="<?=$idbiayatetap;?>">
                                            </div>

                                            <!-- Modal footer -->
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapusbiayatetap">Ya</button>
                                            ...
                                            <!-- The Modal edit -->
                                            <div class="modal" id="edit<?=$idbiayatetap;?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">

                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <h4 class="modal-title"> Edit Data Pengeluaran Tetap</h4>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                ...
                                                <textarea name="catatan"  class="form-control mb-2" cols="30" rows="5" placeholder="Catatan"> <?=$catatan;?></textarea>
                                                    ...
                                                    <input type="hidden" name="editidtetap" value="<?=$idbiayatetap;?>">
                                                </div>

                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-success" name="editbiayatetap">Edit</button>
                                         ...
                                         <!-- The Modal hapus-->
                                        <div class="modal" id="delete<?=$idmuzakki;?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                            Apakah Anda yakin ingin menghapus??
                                            <input type="hidden" name="idmuzakki1" value="<?=$idmuzakki;?>">
                                            </div>

                                            <!-- Modal footer -->
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapusmuzakki">Ya</button>
                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Tidak</button>
                                            </div>
        ...
        <script src="js/datatables-simple-demo.js"></script>
                ...
                <div class="modal-dialog">
                    ...
                    <!-- Modal footer -->
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" name="tambahbiayatetap">Simpan</button>
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Kembali</button>
                    </div>
